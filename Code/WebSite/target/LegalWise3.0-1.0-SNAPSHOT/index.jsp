...
<div class="content bck-white"
	...
	<div class="control margin-bottom-lg">										
		...
		<input type="text"
			...
			autocomplete="off" 
			placeholder="Search LegalWise 3.0">
	</div>
	<div class="row">
		<div class="col-sm-9">
			...
			<div ng-if="search.result">
				...
				<div ng-repeat="doc in search.result.docs"
					...
					<div class="row" 
						...
						<div class="col-sm-9">
							<h4 class="margin-bottom-xs text-one-line" 
								ng-attr-title="{{doc.title}}">
								<span ng-if="search.getAnswerType(doc) == 'QA'" 
									class="bck-green text-white h6">
									&nbsp;QA&nbsp;</span>
								<span ng-if="doc.title_highLight == null" ng-bind-html="doc.title"></span>
								<span ng-bind-html="doc.title_highLight"></span>	 
							</h4>
							<h5  ng-if = "doc.sub_title" class="margin-bottom-xs text-one-line"								 
								ng-attr-title="{{doc.sub_title}}">
								<span ng-if="search.getAnswerType(doc) == 'HN'" 
									class="bck-orange text-white h6">
									&nbsp;HN&nbsp;</span>
								<span ng-if="doc.sub_title_highLight == null" ng-bind-html="doc.sub_title"></span>
								<span ng-bind-html="doc.sub_title_highLight"></span>	
							</h5>													
							<p class="h6 text-gray margin-bottom-sm">
								<span class="text-pre" 
									ng-if="doc.showAll"
									ng-bind-html="doc.body">								
								</span>
								...
								<span class="text-pre" 
									ng-if="!doc.showAll && doc.body_highLight == null"
									ng-bind-html="doc.body | cut">								
								</span>
								<span class="text-pre" 
									ng-if="!doc.showAll && doc.body_highLight != null"
									ng-bind-html="doc.body_highLight | cut">								
								</span>
								<a href="javascript:void(0)"
									ng-if="doc.body.length > 200 &&
										!doc.showAll"
							...
							<p class="h6 text-one-line"
								ng-if="doc.fileID">
								<a ng-href="{{serverUrl
								}}/service/download?fileId={{doc.fileID}}"
								ng-bind="doc.fileName"></a>
							</p>
						</div>
